...
<form name="updvalues" onsubmit="return validate()" method="post">
<table align="center" border-radius:20px  bordercolor="white" cellpadding=10 cellspacing=20>
<h1 align="center" style="color:purple;">Updation Page</h1>
...
mysqli_query($con,"UPDATE biodata SET firstname='$firstname', lastname='$lastname', age='$age',gendertype='$gendertype ' WHERE id='".$id."'");
echo"Data updated";
mysqli_close($con);
